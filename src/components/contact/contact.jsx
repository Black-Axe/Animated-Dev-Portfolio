...
let emailURL = "localhost:5000/api/email";
let recaptchaVerify = "localhost:5000/api/recaptcha";
let emailLink = "myemail@email.com"
let recaptchaSiteKey = "getthisfromgooglepi";
                            ...
                            <div className="col-lg-6 order-2 order-lg-1 visibleOverParticles">
                                <div className="section-title text-left mb--50">
                                    ...
                                    ""
                                        ...
                                        <a href={"mailto:" + emailLink}>{emailLink}</a> </p>
                        </div>
                            {

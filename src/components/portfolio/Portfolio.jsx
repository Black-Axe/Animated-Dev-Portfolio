                        ...
                        <div className="row">
                            <div className="col-lg-12 visibleOverParticles">
                                <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                                    <h2 className="title">My <span className="blueify">Laboratory</span></h2>
                                    <p>A sampling of some of the works I have <span className="blueify">brewed</span> up.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                                            ...
                                            <div className="content">
                                                <div className="innerPort">
                                                    ...
                                                    <div className="portfolio-button">
                                                        <span className="rn-btn white-buttn"
                                                            onClick={
                                                                () => {
                                                            ...
                                                            Details <GiMagnifyingGlass /></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="col-lg-12 visibleOverParticles">
                                <div className="view-more-btn mt--60 mt_sm--30 text-center">
                                    <a className="rn-button-style--2 btn-solid"
                                        ...
                                        href={GHLink}><span>View all on Github</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={3} sm={3}>
                                ...
                                <p className="proj-cat">
                                    <span className="blueify">Project Title: </span> {selectedProject?.title}</p>
                                <p className="proj-cat"><span className="blueify">Category: </span> {selectedProject?.category}</p>
                                <p className="proj-cat"><span className="blueify">Technologies: </span>
                                    {selectedProject?.tech}
                                </p>
                                <p className="proj-cat"><span className="blueify">Project Link: </span>
                                    <a className="whitefy" href={selectedProject?.link} target="_blank" rel="noopener noreferrer">Visit</a>
                                </p>
                                <p className="proj-cat"><span className="blueify">GitHub: </span>
